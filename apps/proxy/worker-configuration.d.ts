/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env dev` (hash: b6bb5bd8a8c2eb190b45044c9e30d71a)
// Runtime types generated with workerd@1.20260219.0 2025-09-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "AgentRelaySession" | "ProxyTrustState" | "NonceReplayGuard";
	}
	interface Env {
		...
		AGENT_RELAY_SESSION: DurableObjectNamespace<import("./src/worker").AgentRelaySession>;
		PROXY_TRUST_STATE: DurableObjectNamespace<import("./src/worker").ProxyTrustState>;
		NONCE_REPLAY_GUARD: DurableObjectNamespace<import("./src/worker").NonceReplayGuard>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "REGISTRY_URL" | "INJECT_IDENTITY_INTO_MESSAGE" | "RELAY_QUEUE_MAX_MESSAGES_PER_AGENT" | "RELAY_QUEUE_TTL_SECONDS" | "RELAY_RETRY_INITIAL_MS" | "RELAY_RETRY_MAX_MS" | "RELAY_RETRY_MAX_ATTEMPTS" | "RELAY_RETRY_JITTER_RATIO">> {}
}
