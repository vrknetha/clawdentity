/* eslint-disable */
// Generated by Wrangler by running `wrangler --cwd apps/proxy types --env dev` (hash: dc5827228fb6484fcb5b0f01c54ab10d)
// Runtime types generated with workerd@1.20260219.0 2025-09-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "AgentRelaySession" | "ProxyTrustState";
	}
	interface Env {
		ENVIRONMENT: string;
		APP_VERSION: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "APP_VERSION" | "REGISTRY_URL" | "OPENCLAW_BASE_URL" | "REGISTRY_INTERNAL_SERVICE_ID" | "REGISTRY_INTERNAL_SERVICE_SECRET" | "INJECT_IDENTITY_INTO_MESSAGE" | "RELAY_QUEUE_MAX_MESSAGES_PER_AGENT" | "RELAY_QUEUE_TTL_SECONDS" | "RELAY_RETRY_INITIAL_MS" | "RELAY_RETRY_MAX_MS" | "RELAY_RETRY_MAX_ATTEMPTS" | "RELAY_RETRY_JITTER_RATIO">> {}
}
