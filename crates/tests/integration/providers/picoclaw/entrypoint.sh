...
PROVIDER_ID="picoclaw"
CLAWDENTITY_HOME="${CLAWDENTITY_HOME:-/var/lib/clawdentity/picoclaw}"
MOCK_REGISTRY_URL="${MOCK_REGISTRY_URL:-http://mock-registry:13370}"
MOCK_PROXY_URL="${MOCK_PROXY_URL:-http://mock-proxy:13371}"
API_KEY="${API_KEY:-pat_picoclaw}"
AGENT_NAME="${AGENT_NAME:-picoclaw-agent}"
FRAMEWORK="${FRAMEWORK:-picoclaw}"
...
RUNTIME_HOOK_TOKEN="${RUNTIME_HOOK_TOKEN:-picoclaw-hook-token}"
PLATFORM_RUN_CMD="${PLATFORM_RUN_CMD:-picoclaw gateway}"
