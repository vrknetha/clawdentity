...
use crate::provider::{
    ...
    read_provider_agent_marker, read_text, resolve_home_dir_with_fallback, resolve_state_dir,
    save_provider_runtime_config, upsert_marked_block, write_json, write_provider_agent_marker,
    write_text,
};
